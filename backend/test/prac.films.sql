INSERT INTO film (id, rating, director, tags, title, about, description, image, cover) VALUES
...
INSERT INTO film (id, rating, director, tags, title, about, description, image, cover) VALUES
('51b4bc85-646d-47fc-b988-3e7051a9fe9e', 9, 'Харрисон Рид', ARRAY['Рекомендуемые'], 'Недостижимая утопия',
